...
### Simulation
L'apprentissage sur la simulation se fait avec le simulateur coppelia. La première
chose que vous devez donc faire est de [télécharger](http://www.coppeliarobotics.com/downloads.html)
la version de coppelia  correspondant à votre OS (Win, OS X, Linux disponibles).
Dans ce code, on utilise l'API externe de coppelia  en python, il va donc falloir
